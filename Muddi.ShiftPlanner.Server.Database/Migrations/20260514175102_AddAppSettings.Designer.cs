...
namespace Muddi.ShiftPlanner.Server.Database.Migrations
{
    ...
    [Migration("20260514175102_AddAppSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Muddi.ShiftPlanner.Server.Database.Entities.AppSettingsEntity", b =>
                {
                    b.Property<int>("Id")
            ...
            modelBuilder.Entity("Muddi.ShiftPlanner.Server.Database.Entities.SeasonEntity", b =>
                {
                    ...
                    b.Property<bool>("IsSelectedAsCurrent")
                        .HasColumnType("boolean")
                        .HasColumnName("is_selected_as_current");
            ...
            modelBuilder.Entity("Muddi.ShiftPlanner.Server.Database.Entities.AppSettingsEntity", b =>
                {
                    b.OwnsOne("Muddi.ShiftPlanner.Shared.Entities.ApplicationSettings", "Settings", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_app_settings_app_settings_id");
                        });
            ...
            modelBuilder.Entity("Muddi.ShiftPlanner.Server.Database.Entities.ShiftFrameworkTypeCountEntity", b =>
                {
                    b.HasOne("Muddi.ShiftPlanner.Server.Database.Entities.ShiftFrameworkEntity", "ShiftFramework")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shift_framework_type_count_entity_shift_frameworks_shift_fr");
